...
try {
  require('../../static/assets/js/jquery')
  require('../../static/assets/js/jquery.scrolly.min')
  require('../../static/assets/js/browser.min')
  require('../../static/assets/js/breakpoints.min')
  require('../../static/assets/js/util')
  ...
  <React.Fragment>
    <section id="header">
      <div className="inner">
        ...
        <h1>
          Hi, I'm
          <strong>Photon</strong>, another fine
          <br /> little freebie from
          <a href="http://html5up.net">HTML5 UP</a>.
        </h1>
        <p>
          Accumsan feugiat mi commodo erat lorem ipsum, sed magna
          <br /> lobortis feugiat sapien sed etiam volutpat accumsan.
        </p>
        ...
        <div className="row gtr-150">
          ...
          <div className="col-6 col-12-medium">
            ...
            <p>
              ...
              non nisl amet vis volutpat aclacus nascetur ac non. Lorem curae eu ante amet sapien in
      ...
      <div className="container">
        ...
        <div className="row gtr-150">
          <div className="col-4 col-12-medium">
            ...
            <p>
              Adipiscing a commodo ante nunc magna lorem et interdum mi ante nunc lobortis non amet
              vis sed volutpat et nascetur.
            </p>
            <ul className="actions special">
              <li>
